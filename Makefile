...
$(BUILD_DIR)/gen: generators/gen_bit.h_.c
	mkdir -p $(BUILD_DIR)
	gcc -Wall -std=c99 -o $(BUILD_DIR)/gen generators/gen_bit.h_.c

$(BUILD_DIR)/binary_characters: generators/gen_binary_characters.c
	mkdir -p $(BUILD_DIR)
	gcc -Wall -std=c99 -o $(BUILD_DIR)/binary_characters generators/gen_binary_characters.c
